export default {
  translation: {
    ...
    login: {
      ...
      nicknamePlaceholder: 'กรุณากรอกชื่อเล่น',
      register: 'Create an account',
      continue: 'ดำเนินการต่อ',
      title: 'AI-powered intelligence platform — faster analysis, smarter decisions',
    ...
    header: {
      knowledgeBase: 'ชุดข้อมูล',
      chat: 'แชท',
      register: 'สมัครสมาชิก',
      signin: 'เข้าสู่ระบบ',
      home: 'หน้าแรก',
      setting: 'ตั้งค่าผู้ใช้',
      logout: 'ออกจากระบบ',
      fileManager: 'ไฟล์',
      flow: 'เอเจนต์',
      search: 'ค้นหา',
...
Procedural Memory: Learned skills, habits, and automated procedures.`,
      ...
      editName: 'Edit name',
      memory: 'Memory',
      createMemory: 'สร้างความจำ',
      name: 'ชื่อ',
      memoryNamePlaceholder: 'memory name',
      memoryType: 'ประเภทความจำ',
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeList: {
      ...
      createKnowledgeBase: 'สร้างชุดข้อมูล',
      name: 'ชื่อ',
      namePlaceholder: 'Please input name.',
      doc: 'Docs',
      searchKnowledgePlaceholder: 'Search',
      noMoreData: `That's all. Nothing more.`,
      parserRequired: 'ต้องระบุวิธีแบ่งชิ้น',
    },
    knowledgeDetails: {
      metadata: {
        ...
        metadataGenerationSettings: 'การตั้งค่าการสร้างข้อมูลเมตา',
        // manageMetadataForDataset: 'Manage metadata for this dataset',
        manageMetadata: 'จัดการข้อมูลเมตา',
        metadata: 'ข้อมูลเมตา',
        values: 'Values',
        value: 'ค่า',
        action: 'การดำเนินการ',
      ...
      generate: 'สร้าง',
      raptor: 'RAPTOR',
      processingType: 'ประเภทการประมวลผล',
      ...
      source: 'แหล่งที่มา',
      fileName: 'ชื่อไฟล์',
      datasetLogs: 'ชุดข้อมูล',
      fileLogs: 'File',
      overview: 'Logs',
      success: 'สำเร็จ',
      failed: 'ล้มเหลว',
      completed: 'เสร็จสมบูรณ์',
      datasetLog: 'บันทึกชุดข้อมูล',
      created: 'สร้างเมื่อ',
      learnMore: 'Built-in pipeline introduction',
      general: 'ทั่วไป',
      chunkMethodTab: 'วิธีแบ่งชิ้น',
      testResults: 'Results',
      testSetting: 'Setting',
      ...
      Parse: 'Parse',
      dataset: 'ชุดข้อมูล',
      testing: 'ทดสอบการดึงข้อมูล',
      files: 'files',
      configuration: 'การกำหนดค่า',
      knowledgeGraph: 'กราฟความรู้',
      name: 'ชื่อ',
      namePlaceholder: 'Please input name!',
      doc: 'Docs',
      datasetDescription:
      ...
      processDuration: 'ระยะเวลา',
      progressMsg: 'ความคืบหน้า',
      ...
      similarityThreshold: 'เกณฑ์ความคล้ายคลึง',
      ...
      vectorSimilarityWeight: 'น้ำหนักความคล้ายคลึงแบบเวกเตอร์',
      ...
      keywordSimilarityWeight: 'น้ำหนักความคล้ายคลึงแบบคำหลัก',
...
`,
      ...
      plainText: 'Naive',
      reRankModelWaring: 'โมเดล Re-rank ใช้เวลานานมาก',
    },
    knowledgeConfiguration: {
      ...
      globalIndexModel: 'โมเดลสร้างดัชนี',
      settings: 'ตั้งค่า',
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      modelSetting: 'ตั้งค่าโมเดล',
      chat: 'แชท',
      newChat: 'แชทใหม่',
      send: 'Send',
      sendPlaceholder: 'ส่งข้อความถึงผู้ช่วย...',
      chatConfiguration: 'การตั้งค่าแชท',
      ...
      **Essential Rules:**
      ...
      operation: 'Operation',
      model: 'โมเดล',
      modelTip: 'โมเดลภาษาขนาดใหญ่สำหรับแชท',
      modelMessage: 'กรุณาเลือก!',
      modelEnabledTools: 'เครื่องมือที่เปิดใช้',
...
Example: Virtual Hosted Style`,
      ...
      model: 'ผู้ให้บริการโมเดล',
      systemModelDescription: 'กรุณาตั้งค่าเหล่านี้ก่อนเริ่มใช้งาน',
  ...
  The above is the content you need to summarize.`,
      ...
      createFromTemplates: 'สร้างจากเทมเพลต',
      retrieval: 'Retrieval',
      generate: 'สร้าง',
      answer: 'Interact',
...
[Insert text here]`,
    ...
    empty: {
      ...
      chatTitle: 'ยังไม่มีแอปแชท',
      notFoundChat: 'Chat app not found',
      searchTitle: 'ยังไม่มีแอปค้นหา',
